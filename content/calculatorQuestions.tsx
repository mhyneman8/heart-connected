...
const calcQuestions: CalcQuestions[] = [
	{
        question: 'Define your relationship to your family member with CHD.',
        questionNumber: 1,
        choices: [
            ['Mother', 1],
            ['Father', 0],
	...
	{
        question: 'Birthing parent only: Have you been diagnosed with postpartum depression after the birth of your child with CHD?',
        questionNumber: 9,
        choices: [
            ['Yes', 2],
            ['No', 0],
