		...
		<div className='max-w-[1000px] m-auto'>
			...
			<div className='body text-black md:px-10 px-5 flex justify-center flex-col'>
				...
				<div className='flex flex-row pt-8 justify-center'>
					<p className=''>
						Early cardiac development begins with single triple-layer pipe that twists and folds upon itself creating a
				...
				<p className='pt-8'>
					Then the electrical conduction system matures followed by complete division of the four heart chambers,
					turning a single bloodstream into distinct pulmonary and systemic loops with the heart being the go between.
					This is a result of cushions that fuse and form the walls separating the heart chambers.
				</p>
				<p className='pt-8'>
				...
				<p className='mt-8'>
					...
					{/* </Tooltip> */}, double outlet right ventricle (DORV) , and pulmonary atresia occur.
				</p>
			...
			<div className='video-wrapper flex flex-col justify-center  lg:flex-row mb-20 mt-20'>
				<div className={videoBoxStyles}>
					<button onClick={() => setShowVideo(true)}>
						...
						<div className='text-xs text-left'>caption</div>
					</button>
				</div>
			</div>
			<div className='video-wrapper flex flex-col justify-center lg:flex-row mb-20 mt-20'>
				<div className={videoBoxStyles}>
					<button onClick={() => setShowVideo2(true)}>
						<div className={textBoxStyles}>Development of the ventricles and large arterial vessels</div>
						<div className="z-10 justify-center align-center flex'">
							<Image
								src='/living-with-CHD.png'
								width={384}
