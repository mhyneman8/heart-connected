...
const aboutContent: AboutContent[] = [
	{
		content:
			'One percent of all children are born with a congenital heart disease. Yet, we often use words like “rare” to define them leaving parents, families, and children with CHD feeling isolated and helpless. Whether the disease is classified as mild or severe, CHD parents are at risk of developing a traumatic response just from being told the diagnosis, let alone the other events that are often associated with CHD care. Our hope through the development of this website is to build a local and expand on the national community around CHD so no parent, child, or sibling feels alone. The congenital heart disease community is strong and supportive, but finding the right resources and sifting through all the information out there can be difficult. We hope that this website can serve as a central hub that promotes the already fantastic organizations that have been tirelessly working to improve care, for both the patients and families of CHD.',
	},
	{
		heading: 'Our Mission:',
		content:
